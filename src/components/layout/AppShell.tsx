      ...
      >
        ...
        <div className="shrink-0 flex flex-col p-4 gap-3 border-t border-white/[0.06] bg-[#030303]">
          ...
          <div className="flex items-center justify-between group px-1 pt-1">
            ...
            <button onClick={() => signOut()} aria-label="Se déconnecter" className="p-2 text-[#666666] hover:text-white hover:bg-white/[0.06] rounded-[6px] transition-all focus:outline-none">
